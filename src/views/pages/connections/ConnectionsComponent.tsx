    ...
    <Card>
      <CardContent sx={{ textAlign: 'center', '& svg': { mb: 2 }, marginTop: -5 }}>
        ...
        <Stack direction='row' sx={{ mb: 4, marginTop: -16, marginLeft: 6 }}>
          <Stack spacing={0.1}>
            <Typography sx={{ fontSize: 15, fontWeight: 600 }}>test_connection</Typography>
            <Typography sx={{ fontSize: 10, fontWeight: 600 }}>KAFKA</Typography>
          </Stack>
          <MoreButton />
        </Stack>
        <Typography sx={{ mb: 3, marginLeft: -48, fontWeight: 600, fontSize: 14 }}>Details</Typography>
        <Typography sx={{ mb: 3, marginLeft: -48, marginTop: -2.5, fontSize: 14 }}>127.1.1.1</Typography>
        <br />
        <br />
        <br />
        <br />
